...
- ✅ **AI Chatbot Assistant** - Interactive chatbot with natural language processing
- ✅ **Certificate Gallery** - Interactive modal preview of professional certifications
- ✅ **CV Preview & Download** - View and download resume with modal preview
- ✅ **Contact Form** - Formspree integration for direct email communication
- ✅ **Smooth Animations** - Professional transitions and effects
- ✅ **Modern UI/UX** - Clean, professional design with green color scheme
...
│   ├── certificates.js    # Certificate modal functionality
│   ├── cv-preview.js      # CV preview modal
│   └── chatbot.js         # AI chatbot with NLP
├── assets/
│   ├── images/
